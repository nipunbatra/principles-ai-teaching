...
![bg right:50% w:95%](diagrams/png/paradigm_change.png)
...
![bg right:50% w:95%](diagrams/png/bio_vs_artificial_neuron.png)
...
Where $\text{step}(z) = 1$ if $z > 0$, else 0.
...
- $(0,0)$: $\text{step}(0 + 0 - 1.5) = \text{step}(-1.5) = 0$ ✓
- $(0,1)$: $\text{step}(0 + 1 - 1.5) = \text{step}(-0.5) = 0$ ✓
- $(1,0)$: $\text{step}(1 + 0 - 1.5) = \text{step}(-0.5) = 0$ ✓
- $(1,1)$: $\text{step}(1 + 1 - 1.5) = \text{step}(0.5) = 1$ ✓
...
- $(0,0)$: $\text{step}(0 + 0 - 0.5) = \text{step}(-0.5) = 0$ ✓
- $(0,1)$: $\text{step}(0 + 1 - 0.5) = \text{step}(0.5) = 1$ ✓
- $(1,0)$: $\text{step}(1 + 0 - 0.5) = \text{step}(0.5) = 1$ ✓
- $(1,1)$: $\text{step}(1 + 1 - 0.5) = \text{step}(1.5) = 1$ ✓
...
- $(0)$: $\text{step}(0 + 0.5) = \text{step}(0.5) = 1$ ✓
- $(1)$: $\text{step}(-1 + 0.5) = \text{step}(-0.5) = 0$ ✓
...
![w:1100](diagrams/png/decision_boundaries_gates.png)
...
![bg right:45% w:95%](diagrams/png/mlp_architecture_clean.png)
...
**Layer 2:** $\hat{\mathbf{y}} = W_2 \mathbf{h} + \mathbf{b}_2$

**Substitute:**

$$\hat{\mathbf{y}} = W_2(W_1 \mathbf{x} + \mathbf{b}_1) + \mathbf{b}_2 = \underbrace{(W_2 W_1)}_{W'}\mathbf{x} + \underbrace{(W_2 \mathbf{b}_1 + \mathbf{b}_2)}_{\mathbf{b}'}$$
...
![w:1100](diagrams/png/why_nonlinearity.png)
...
![w:1100](diagrams/png/activation_functions_comparison.png)
...
- $h_1 = \text{step}(x_1 + x_2 - 0.5) \quad \rightarrow$ **OR gate**
- $h_2 = \text{step}(x_1 + x_2 - 1.5) \quad \rightarrow$ **AND gate**
...
|---|------|------|
| $(0,0) \rightarrow 0$ | Not separable | $(0, 0)$ → **separable!** |
...
![w:1100](diagrams/png/xor_hidden_space.png)
...
$$P = \left[\frac{e^{2.0}}{e^{2.0} + e^{1.0} + e^{0.1}}, \ \frac{e^{1.0}}{\ \ldots\ }, \ \frac{e^{0.1}}{\ \ldots\ }\right] = [0.659, 0.242, 0.099]$$
...
![w:1100](diagrams/png/softmax_visualization.png)
...
**Try the interactive autograd playground:** [interactive_comp_graph.html](interactive_comp_graph.html)
